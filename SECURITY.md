...
This is the Vivijure audio upscale module, a resemble-enhance-based finish container, invoked by the Vivijure studio and its render backend (the trusted control plane). It
